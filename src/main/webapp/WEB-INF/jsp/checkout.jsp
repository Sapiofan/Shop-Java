...
<main>
    ...
    <div class="cart-container">
        ...
        <div class="products">
            <div class="product">
                <img src="https://i.allo.ua/media/catalog/product/cache/1/thumbnail/48x48/9df78eab33525d08d6e5fb8d27136e95/1/1/11_451_5_1.jpg"
            ...
            <div class="product">
                ...
                <div class="input-group">
                    ...
                    <input class="input-group-field quantity" min="1" max="1000" type="number" name="quantity1"
                           value="1">
                    <div class="input-group-button">
            ...
            <div class="product">
                ...
                <div class="input-group">
                    ...
                    <input class="input-group-field quantity" min="1" max="1000" type="number" name="quantity2"
                           value="1">
                    <div class="input-group-button">
            ...
            <div class="product">
                ...
                <div class="input-group">
                    ...
                    <input class="input-group-field quantity" min="1" max="1000" type="number" name="quantity3"
                           value="1">
                    <div class="input-group-button">
