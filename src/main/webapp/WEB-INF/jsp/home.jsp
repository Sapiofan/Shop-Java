    ...
    <main>
        <section id="advantages">
            <div class="advantages-padding">
                <div class="advantage">
<%--                    <svg preserveAspectRatio="xMidYMid meet" data-bbox="21 41.657 157.001 114.861" viewBox="21 41.657 157.001 114.861" height="200" width="200" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-labelledby="svgcid-v4szqc1sztyb"><defs><style>#comp-km3aq0p4 svg [data-color="1"] {fill: #000000;}--%>
<%--                    #comp-km3aq0p4 svg [data-color="2"] {fill: #751FFF;}</style></defs><title id="svgcid-v4szqc1sztyb"></title>--%>
<%--                        <g>--%>
...
<%--                    </svg>--%>
                ...
                <div class="advantage">
<%--                    <svg preserveAspectRatio="xMidYMid meet" data-bbox="22 29.01 158 141.964" viewBox="22 29.01 158 141.964" height="200" width="200" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-labelledby="svgcid--e64irn-sou4tc"><defs><style>#comp-km3c06wy svg [data-color="1"] {fill: #000000;}--%>
<%--                    #comp-km3c06wy svg [data-color="2"] {fill: #751FFF;}</style></defs><title id="svgcid--e64irn-sou4tc"></title>--%>
<%--                        <g>--%>
...
<%--                    </svg>--%>
                ...
                <div class="advantage">
<%--                    <svg preserveAspectRatio="xMidYMid meet" data-bbox="31.078 22 137.843 155.564" viewBox="31.078 22 137.843 155.564" height="200" width="200" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-labelledby="svgcid-75kg2nvts9zr"><defs><style>#comp-km3aqc4u svg [data-color="1"] {fill: #000000;}--%>
<%--                    #comp-km3aqc4u svg [data-color="2"] {fill: #751FFF;}</style></defs><title id="svgcid-75kg2nvts9zr"></title>--%>
<%--                        <g>--%>
...
<%--                    </svg>--%>
                ...
                <div class="advantage">
<%--                    <svg preserveAspectRatio="xMidYMid meet" data-bbox="18.037 24.249 169.427 148.092" viewBox="18.037 24.249 169.427 148.092" height="200" width="200" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-labelledby="svgcid-dv0c9tt0hsw0"><defs><style>#comp-km3aq0qx svg [data-color="1"] {fill: #000000;}--%>
<%--                    #comp-km3aq0qx svg [data-color="2"] {fill: #751FFF;}</style></defs><title id="svgcid-dv0c9tt0hsw0"></title>--%>
<%--                        <g>--%>
